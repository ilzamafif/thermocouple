...
<body>
	...
	<div class="row justify-content-center">
		<div class="col-md-9 baris-3">
			...
			<button class="btn btn-danger my-1 ms-2" id="alarm_button" style="display: none;"
				onclick="handleAlarmClick()">Alarm Triggered</button>
	...
	<script>
		...
		channel.bind('sensor-event', function (data) {
			...
			myChart.data.labels.push(new Date().toLocaleTimeString("pt-BR", optionsTime));
			myChart.data.datasets[0].data.push(data.data);
			fileContent += `${new Date().toLocaleString("pt-BR")} - Suhu: ${data.data}°C\n`;
			...
			cell2.textContent = new Date().toLocaleString("pt-BR", options);
